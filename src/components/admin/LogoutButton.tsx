...
export default function LogoutButton() {
  ...
  return (
    <button
      ...
      className="flex w-full items-center gap-3 rounded-lg border-l-2 border-transparent py-2 pl-2.5 pr-3 text-sm font-medium text-slate-300 transition hover:bg-slate-800/60 hover:text-white disabled:opacity-50"
    >
